...
export function DashboardActions() {
  ...
  return (
    <div className="flex items-center gap-2.5">
      <button
        onClick={openNew}
        className="inline-flex items-center gap-2 h-11 px-5 rounded-full bg-primary text-primary-foreground font-medium text-[13.5px] shadow-pb-2 hover:opacity-90 transition"
      >
